...
public class ComponenteButao implements Serializable {
    ...
    public ComponenteButao(String nome, String descrição, String tipo, Integer pino, Integer imgEstadoResource, Boolean estado) {
        this.nome = nome;
